...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <link rel="stylesheet" href="http://laravel.com/css/style.css">
    ...
    <body>
        ...
        <div class="container">
            ...
            <nav class="menu">
                <ul>
                    <li class="active"><a href="http://laravel.com/" title="Welcome">{{'Welcome'}}</a></li>
    ...
    <section class="partners">
        <div class="container">
                ...
                <div class="friend-logo">
                    <a href="http://www.cartalyst.com/" title="Cartalyst"><img src="http://laravel.com/img/cartalyst.png"></a>
                </div>
                <div class="friend-caption">
                    {{'Cartalyst, a Laravel community sponsor, is the leader in premium add-ons and extensions to the Laravel framework. Their arsenal of high quality components will take your application to the next level.'}}
                </div>
            </div>
                        <div class="clearfix"></div>
        </div>
